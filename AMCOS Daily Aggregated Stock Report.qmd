...
total_sheet = xlsx::createSheet(wb, sheetName = "Total Beans")
variety_sheet = xlsx::createSheet(wb, sheetName = "Variety Beans")

xlsx::addDataFrame(faab_data_summary,total_sheet)
xlsx::addDataFrame(variety_data_summary,variety_sheet)

xlsx::saveWorkbook(wb,here::here(paste0("AMCOS-Daily-Aggregated-Stock-Report_",lubridate::today(),".xlsx")))
